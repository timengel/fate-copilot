...
describe('useCampaignsStore', () => {
  ...
  it('removeMilestone removes from the campaign', () => {
    const store = useCampaignsStore()
    store.addCampaign(makeCampaign({ id: 'c1', milestones: [{ id: 'm1', type: 'small', description: 'First' }] }))
  ...
  it('updateMilestone updates the correct milestone', () => {
    const store = useCampaignsStore()
    store.addCampaign(makeCampaign({ id: 'c1', milestones: [{ id: 'm1', type: 'small', description: 'Old' }] }))
